...
export const strings: Record<string, LanguageStrings> = {
  en: {
    ...
    dashboard: {
      ...
      weakAreaFocus: "Weak Area Focus",
      aiPersonalized: "AI Personalized",
      goalAchieved: "Goal Achieved!",
      goalProgress: "complete - {time} remaining",
      aiIdentifiedWeakArea: "AI identified this as your weakest area ({score}% score)",
      aiRecommendsFocus: "AI recommends focusing here first",
      currentScore: "Current Score",
      targetScore: "Target: 80%",
      toGo: "{percent}% to go",
      personalizedExamInfo: "Your mock exams are automatically personalized based on your weak areas. Each exam focuses on topics where you need the most practice, ensuring maximum learning efficiency.",
      examFocusedOn: "Focused on your weak areas:",
      examTailored: "This exam is tailored to help you improve where you need it most"
    },
    settings: {
      title: 'Settings',
      account: 'Account',
  ...
  nl: {
    ...
    dashboard: {
      ...
      aiAdaptive: "AI Adaptief",
      weakAreaFocus: "Zwakke Punt Focus",
      aiPersonalized: "AI Gepersonaliseerd",
      goalAchieved: "Doel Bereikt!",
      goalProgress: "voltooid - {time} resterend",
      aiIdentifiedWeakArea: "AI heeft dit geïdentificeerd als je zwakste gebied ({score}% score)",
      aiRecommendsFocus: "AI raadt aan hier eerst op te focussen",
      currentScore: "Huidige Score",
      targetScore: "Doel: 80%",
      toGo: "{percent}% te gaan",
      personalizedExamInfo: "Je proefexamens worden automatisch gepersonaliseerd op basis van je zwakke punten. Elk examen richt zich op onderwerpen waar je de meeste oefening nodig hebt, waardoor je leerefficiëntie wordt gemaximaliseerd.",
      examFocusedOn: "Gericht op je zwakke punten:",
      examTailored: "Dit examen is afgestemd om je te helpen verbeteren waar je het meest nodig hebt"
    },
    settings: {
      title: 'Instellingen',
      account: 'Account',
  ...
  ar: {
    ...
    dashboard: {
      ...
      aiAdaptive: "ذكي تكيفي",
      weakAreaFocus: "تركيز على نقاط الضعف",
      aiPersonalized: "مخصص بالذكاء الاصطناعي",
      goalAchieved: "تم تحقيق الهدف!",
      goalProgress: "مكتمل - {time} متبقي",
      aiIdentifiedWeakArea: "حدد الذكاء الاصطناعي هذا كأضعف منطقة لديك ({score}% درجة)",
      aiRecommendsFocus: "يوصي الذكاء الاصطناعي بالتركيز هنا أولاً",
      currentScore: "الدرجة الحالية",
      targetScore: "الهدف: 80%",
      toGo: "{percent}% متبقي",
      personalizedExamInfo: "يتم تخصيص امتحاناتك التجريبية تلقائياً بناءً على نقاط ضعفك. يركز كل امتحان على المواضيع التي تحتاج فيها إلى أكبر قدر من التدريب، مما يضمن أقصى كفاءة تعليمية.",
      examFocusedOn: "مركز على نقاط ضعفك:",
      examTailored: "تم تصميم هذا الامتحان لمساعدتك على التحسين حيث تحتاج إليه أكثر"
    },
    settings: {
      title: 'الإعدادات',
      account: 'الحساب',
